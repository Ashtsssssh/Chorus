...
/**
 * DESIGN DECISION: Luxury Authentication
 * - Minimal hierarchy: only the logo and form matter
 * - Hairline input (border-bottom only)
 * - Text-only buttons with animated underline on hover
 * - Maximum whitespace, minimum visual noise
 * - Typography drives the experience (Cormorant + Work Sans)
 * - One accent color used sparingly (only on primary CTA)
 */
