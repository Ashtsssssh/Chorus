...
export default function JobDetailsModal({ job, onClose }) {
  ...
  const completionPercent = job.totalChunks && job.totalChunks > 0
        ...
        <div style={{ marginBottom: '1.5rem' }}>
          ...
          >
            ...
            >
              ...
              <p
                style={{
                  fontSize: '1rem',
                  fontWeight: 600,
                  color: statusColors[job.status] || 'var(--color-text-primary)',
                  margin: 0,
            ...
            >
              ...
              >
                {visibilityIcon[job.visibility] || ''} {job.visibility || 'public'}
              </p>
            </div>
          </div>
        </div>
